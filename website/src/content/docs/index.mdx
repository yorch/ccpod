---
title: ccpod — Run Claude Code in Docker
description: ccpod runs Claude Code inside a Docker container with portable, versioned profiles. Share, reproduce, and pin your Claude AI development environment across machines and teams.
template: splash
hero:
