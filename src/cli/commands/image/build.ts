...
export default defineCommand({
  ...
  args: {
    ...
    dockerfile: { type: "string", description: "Dockerfile path (overrides profile)" },
    tag: { type: "string", description: "Image tag (overrides auto-generated)" },
  },
  async run({ args }) {
    ...
    const dockerfile = args.dockerfile ?? profile.image.dockerfile ?? "Dockerfile";
    ...
    console.log(chalk.dim(`Update profile image.use to '${tag}' to use this image.`));
  },
});
